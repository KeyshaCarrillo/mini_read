  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        final childMode = profile?.id == '__mini_read_category_mode__';
                  ...
                  ListView(
                    ...
                    children: [
                      ...
                      if (controller.books.isEmpty) ...[
                        ...
                        const SizedBox(height: 12),
                        for (final book in controller.books.where(
                          (book) => book.category == 'Infantil',
                        )) ...[
                          _WideBookTile(
                            book: book,
                            childMode: childMode,
                        ...
                        if (!childMode) ...[
                          ...
                          for (final book
                              in controller.books
                                  .where((book) => book.category != 'Infantil')
                                  .take(3)) ...[
                            _WideBookTile(
                              book: book,
                              childMode: false,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Tu biblioteca está conectada a Firestore.\n\nEl catálogo está vacío porque aún no hay documentos de libros activos en la colección books.',
              style: TextStyle(
